...
class CandidatoVaga(models.Model):
    ...
    triagem_automatica_pontuacao = models.PositiveSmallIntegerField(blank=True, null=True)
    triagem_automatica_classificacao = models.CharField(max_length=40, blank=True, null=True)
