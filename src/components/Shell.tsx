...
const navItems: NavItem[] = [
  ...
  { label: 'Usuários', to: '/rh/usuarios', icon: UserCog, profiles: ['rh_admin'] },
  ...
  { label: 'Meus dados', to: '/funcionario/meus-dados', icon: BadgeCheck, profiles: ['funcionario'] },
  { label: 'Contratos', to: '/funcionario/meus-contratos', icon: FileText, profiles: ['funcionario'] },
  { label: 'Plano', to: '/funcionario/meu-plano-carreira', icon: Milestone, profiles: ['funcionario'] },
  { label: 'Avaliações', to: '/funcionario/minhas-avaliacoes', icon: ClipboardList, profiles: ['funcionario'] },
